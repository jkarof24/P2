...
In this section we will focus on solving the problem statement, that was presented in \ref{sec:PBS}. This will be done by using PRNG to create synthetic data, from this data a polynomial regression will be create via OLS. Afterwards a resampling process will be done, to set up multiple data sets from the original data set, then multiple polynomial regression will be created, one for each new data set. Lastly the regressions will be compared through various metric, such as MBE and RMSE.
