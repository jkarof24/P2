The following sections will focus on the theory behind deterministicly generating random data and using Monte Carlo Bootstrapping to create models from the data.
