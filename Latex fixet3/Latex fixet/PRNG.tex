The following sections will focus on the theory behind deterministicly generating data and using Monte Carlo Bootstrapping to create models from the data.
