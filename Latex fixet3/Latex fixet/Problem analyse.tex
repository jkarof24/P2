Regression models are tools used to understand relationships between variables and for making predictions based on data. However, for this to work, certain assumptions need to be satisfied. 
