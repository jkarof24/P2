Regression models are tools used to understand relationships between variables and to make predictions based on those relationships. However, for this to work, certain assumptions need to be satisfied. 
