...
% \[
% \text{Var}(\varepsilon) = \mathbb{E}(\varepsilon \varepsilon') =
% \begin{bmatrix}
%	\sigma_{11} & \sigma_{12} & \sigma_{13} & \cdots &  \sigma_{1l} \\
%	\sigma_{12} & \sigma_{22} & \sigma_{23} & \cdots & \sigma_{2l} \\
%	\sigma_{13} & \sigma_{23} & \sigma_{33} & \cdots & \sigma_{3l} \\
%	\vdots      & \vdots      & \vdots      & \ddots & \vdots \\
%	\sigma_{1l} & \sigma_{2l} & \sigma_{3l} & \cdots & \sigma_{ll}
%\end{bmatrix}
%\]
%\newline
