Assumptions need to be met before proceeding with modeling a regression. Here are assumptions, that need to be met so the calculated estimates of the coefficients are accurate.
\newline 
