...
%\lstinputlisting[language=R, caption=super syntetisk data]{super syntetisk data_.R}



\begin{figure}[h] 
	\centering\includegraphics[width=14cm]{p2/4.png}
	\caption{residualplot}
	\label{fig:j06}
\end{figure}

\begin{figure}[h] 
	\centering\includegraphics[width=14cm]{p2/5.png}
	\caption{scatterplot.homo}
	\label{fig:j06}
\end{figure}

\begin{figure}[h] 
	\centering\includegraphics[width=14cm]{p2/6.png}
	\caption{scatterplot.hetro}
	\label{fig:j06}
\end{figure}

\begin{figure}[h] 
	\centering\includegraphics[width=14cm]{p2/7.png}
	\caption{his.homo}
	\label{fig:j06}
\end{figure}
